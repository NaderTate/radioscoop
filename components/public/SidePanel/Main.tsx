  ...
  return (
    <div className="lg:max-w-xs mb-4  lg:mr-2">
      <div className="hidden lg:flex flex-col gap-3 ">
        <div className="rounded-lg sm:h-auto flex flex-col justify-between shadow-xl bg-slate-700 hover:scale-[1.01] cursor-pointer w-full">
          <Link href={{ pathname: `/programs/67c2f44626a0ed1d15a24ea8` }}>
            <div className="w-full rounded-lg p-3 shadow-sm ">
              <img
                src="https://b.l3n.co/i/YuQdF7.jpg"
        ...
        >
          <SwiperSlide>
            <Link href={{ pathname: `/programs/67c2f44626a0ed1d15a24ea8` }}>
              <div
                style={{
                  backgroundImage: `url(https://b.l3n.co/i/YuQdF7.jpg)`,
